 ...
 * Copyright (c) 2014 John MacDougall
 * jmac@creativelycoded.com
 *
...
(function(jQuery){
    ...
    $('.cre-animate').css({'position':'relative'});
        $('.cre-animate').each(function(index, value){
    ...
    // CALCULATES THE TRIGGER POINT USING THE OFFSET
            ...
            triggerpoint = $(window).height() * decimal + $(window).scrollTop(); // Call point in Viewport: viewport height * decimal(%) + pixels to top of window
            element = $(this).offset().top;
    ...
    // ASSIGNS VALUES FOR THE EASING TYPES
            ...
            if (cssEase[dataeasing]) { dataeasing = cssEase[dataeasing]; }
